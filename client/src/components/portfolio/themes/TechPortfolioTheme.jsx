...
const TechPortfolioTheme = ({ data, isDarkMode, toggleDarkMode, accentColor }) => {
  ...
  useEffect(() => {
    ...
    const context = {
      ...
      profileImage: (profile?.profileImage || profile?.image || profile?.avatar || "").trim(),
      image: (profile?.profileImage || profile?.image || profile?.avatar || "").trim(),
      avatar: (profile?.profileImage || profile?.image || profile?.avatar || "").trim(),
