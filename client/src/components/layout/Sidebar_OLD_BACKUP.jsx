        ...
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center px-4 border-b border-gray-200 dark:border-gray-800 relative">
            ...
            <button
              ...
              className={`hidden lg:flex items-center justify-center w-7 h-7 rounded-full bg-blue-600 hover:bg-blue-700 text-gray-900 dark:text-white shadow-lg transition-all duration-200 z-60 border-4 border-white dark:border-gray-900 absolute top-1/2 -translate-y-1/2
                ...
                <BlockableLink
                  ...
                  className={`group flex items-center gap-3 px-3 py-3 rounded-lg transition-all duration-300 ease-out relative overflow-hidden ${
                    location.pathname.startsWith("/admin")
                      ...
                      : "text-gray-700 dark:text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-purple-50/50 hover:to-blue-50/50 dark:hover:from-purple-900/10 dark:hover:to-blue-900/10 hover:translate-x-1"
                  }`}
                  ...
                  <a
                    ...
                    className={`group flex items-center gap-3 px-3 py-3 rounded-lg transition-all duration-300 ease-out relative overflow-hidden ${
                      isActive
                        ...
                        : "text-gray-700 dark:text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:translate-x-1"
                    }`}
          ...
          >
            <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-600 dark:text-gray-400 text-center">
              © 2025 SmartNShine
            </p>
          </div>
        </div>
