...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0D0D0D] overflow-x-hidden">
      {/* Linear-style grid background pattern */}
      <div className="fixed inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none"></div>

      {/* Hero Section - Linear Style */}
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        {/* Gradient blur effects */}
        <div className="absolute top-40 left-20 w-[500px] h-[500px] bg-primary-500/20 rounded-full blur-[120px] pointer-events-none"></div>
        <div className="absolute top-60 right-20 w-[400px] h-[400px] bg-purple-500/20 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            >
              <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-primary-500/10 border border-primary-500/20 rounded-full text-sm font-medium text-primary-600 dark:text-primary-400">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl md:text-7xl font-bold leading-[1.1] text-gray-900 dark:text-gray-900 dark:text-white tracking-tight"
            >
              Your resume,
              <br />
            ...
            <motion.p
              ...
              className="text-xl sm:text-2xl text-gray-600 dark:text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed"
            >
            ...
            >
              <Link
                to="/upload"
                className="group relative inline-flex items-center gap-2 px-6 py-3 bg-primary-600 hover:bg-primary-700 text-gray-900 dark:text-white rounded-lg font-medium transition-all duration-200 shadow-lg shadow-primary-500/25 hover:shadow-xl hover:shadow-primary-500/30 hover:scale-105"
              >
                Start Building Free
              ...
              <Link
                to="#features"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-gray-900 dark:text-white rounded-lg font-medium transition-all duration-200 border border-gray-200 dark:border-gray-700"
              >
                See How It Works
              </Link>
            </motion.div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-400 to-purple-500 border-2 border-white dark:border-gray-900 flex items-center justify-center text-gray-900 dark:text-white font-semibold"
                    >
          ...
          {/* Hero Visual - Optional mockup image */}
          <motion.div
          ...
          >
            <div className="relative max-w-5xl mx-auto">
              ...
              <div className="absolute -top-6 -right-4 z-20 bg-green-500 text-gray-900 dark:text-white px-4 py-2 rounded-lg shadow-xl flex items-center gap-2">
                <Check className="w-5 h-5" />
                <span className="font-semibold">ATS Score: 94%</span>
              </div>

              {/* Resume Preview Placeholder */}
              <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-8 aspect-[16/10]">
                <div className="h-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-lg flex items-center justify-center">
                  <p className="text-gray-600 dark:text-gray-400 dark:text-gray-600 text-lg">
                    Resume Preview
                  </p>
                </div>
              </div>
      ...
      <section id="who" className="py-16 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-2 text-center">
                  {audience.title}
                </h3>
                <p className="text-gray-600 dark:text-gray-600 dark:text-gray-400 text-center">
                  {audience.desc}
                </p>
              </div>
            ))}
      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {features.map((feature, idx) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-3 text-center">
                  {feature.title}
                </h3>
                <p className="text-gray-600 dark:text-gray-600 dark:text-gray-400 leading-relaxed text-center">
                  {feature.description}
                </p>
              </div>
            ))}
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8 md:p-12">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-4">
                    Import Your GitHub Profile
                  </h3>
                  <p className="text-lg text-gray-600 dark:text-gray-600 dark:text-gray-400 mb-6">
                  ...
                  <Link
                    to="/github-import"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-gray-900 dark:text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                  >
                    <span>🔗</span>
                    Try GitHub Import
                    <span>→</span>
      ...
      <section className="py-16 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {whyChooseUs.map((item, idx) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-3">
                  {item.title}
                </h3>
      ...
      <section id="how-it-works" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
                ...
                <div key={idx} className="relative group">
                  ...
                  <div className="relative flex flex-col items-center">
                    ...
                    <div className="relative mb-4">
                      ...
                      {/* Step Number Badge */}
                      <div className="absolute -top-2 -right-2 w-10 h-10 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg shadow-lg">
                        {step.step}
                      </div>
                    </div>
                    ...
                    {/* Step Content */}
                    <div className="text-center">
                      <h3 className="text-lg font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                        {step.title}
                      </h3>
                      <p className="text-sm text-gray-600 dark:text-gray-600 dark:text-gray-400 leading-relaxed">
                        {step.description}
                      </p>
                    </div>
          ...
          <div className="text-center mt-16">
            <Link
              to="/upload"
              className="group relative inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-gray-900 dark:text-white text-xl font-bold rounded-2xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 overflow-hidden"
            >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, idx) => (
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-600 dark:text-gray-400 italic leading-relaxed">
                  "{testimonial.quote}"
                </p>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-900 dark:text-white text-center mb-12">
            ...
            <div className="space-y-4">
              {faqs.map((faq, idx) => (
                ...
                >
                  ...
                  >
                    <span className="text-lg font-semibold text-gray-900 dark:text-gray-900 dark:text-white text-left">
                      {faq.question}
                    </span>
                    <span
                  ...
                  >
                    <div className="px-6 py-4 bg-white/50 dark:bg-gray-800/30 text-gray-600 dark:text-gray-600 dark:text-gray-400 leading-relaxed backdrop-blur-sm">
                      {faq.answer}
                    </div>
                  </div>
                </div>
      ...
      {/* Final CTA Section */}
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-gray-900 dark:text-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
