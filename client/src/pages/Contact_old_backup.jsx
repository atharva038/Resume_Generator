  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-900 dark:text-white mb-3 tracking-tight">
            Contact & Feedback
          </h1>
          <p className="text-gray-600 dark:text-gray-600 dark:text-gray-400 max-w-2xl">
          ...
          <button
            ...
            className={`flex items-center gap-2 py-3 px-4 font-medium transition-all duration-200 border-b-2 ${
              activeTab === "contact"
                ...
                : "border-transparent text-gray-600 dark:text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
            }`}
          >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-4">
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-800">
                <h3 className="text-lg font-semibold mb-6 text-gray-900 dark:text-gray-900 dark:text-white tracking-tight">
                  Contact Information
                </h3>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-sm text-gray-900 dark:text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                      >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-sm text-gray-900 dark:text-gray-900 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors"
                      >
                        +91 9156906881
                      </a>
                    </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {/* Category Selection */}
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 dark:text-gray-700 dark:text-gray-300 mb-3">
                      Category
                    </label>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          } bg-white dark:bg-gray-700 focus:ring-2 dark:text-gray-900 dark:text-white transition-all`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 focus:ring-2 focus:ring-indigo-500 dark:text-gray-900 dark:text-white transition-all"
                    ...
                    <textarea
                      ...
                      className={`w-full px-4 py-3 rounded-xl border ${
                        errors.message
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-300 dark:border-gray-600 focus:ring-indigo-500"
                      } bg-white dark:bg-gray-700 focus:ring-2 dark:text-gray-900 dark:text-white transition-all resize-none`}
        ...
        {activeTab === "feedback" && (
          <div className="space-y-8">
            ...
            {stats && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/20">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-600 dark:text-gray-400 mt-1 font-medium">
                    Total Submitted
                  </div>
                </div>
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/20">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
              <h3 className="text-xl font-bold text-gray-800 dark:text-gray-900 dark:text-white mb-6">
                ...
                {feedbackTypes.map((type) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <h4 className="font-semibold text-gray-800 dark:text-gray-900 dark:text-white mb-1">
                        {type.label}
                      </h4>
              ...
              <form onSubmit={handleFeedbackSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 focus:ring-2 focus:ring-indigo-500 dark:text-gray-900 dark:text-white transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 focus:ring-2 focus:ring-indigo-500 dark:text-gray-900 dark:text-white transition-all resize-none"
