  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="group relative bg-white dark:bg-black border border-gray-200 dark:border-white/10 rounded-2xl p-6 hover:bg-gray-50 dark:hover:bg-white/[0.07] transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-green-50 dark:bg-green-900/10 rounded-2xl p-6 border border-green-200 dark:border-green-500/20">
      ...
      <div className="bg-white dark:bg-black rounded-2xl p-6 border border-gray-200 dark:border-white/10">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          >
            <option value="usage" className="bg-white dark:bg-[#1a1a1a]">
              Sort by Usage
            </option>
            <option value="cost" className="bg-white dark:bg-[#1a1a1a]">
              Sort by Cost
            </option>
            <option value="percentage" className="bg-white dark:bg-[#1a1a1a]">
              Sort by Percentage
            </option>
            <option value="name" className="bg-white dark:bg-[#1a1a1a]">
              Sort by Name
            </option>
          </select>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-white/5 border-b border-gray-200 dark:border-white/10">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-medium text-indigo-500 dark:text-indigo-400 uppercase tracking-wider">
                  Gemini
                </th>
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">
                  Total Cost
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium ${
                        user.tier === "admin"
                          ? "bg-primary-100 text-primary-700 dark:bg-primary-500/15 dark:text-primary-300 border border-primary-200 dark:border-primary-500/20"
